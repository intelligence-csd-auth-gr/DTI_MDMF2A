...
class MDMFAUC_TRANS(MultiViewTransductiveModelBase):
    """Transductive model of MDMFAUC
    Difference with MDWMFAUC
    ...
    def _AGD_optimization(self, drugMats, targetMats):
        ...
        self._idx0 = np.where((self._Y==0) & (self._Omega==1)) # (array([0, 0, 1, 1], dtype=int64), array([0, 1, 1, 2], dtype=int64))
